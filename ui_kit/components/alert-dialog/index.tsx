...
const AlertDialogAction = React.forwardRef<
    ...
    React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Action> & AlertDialogActionProps
...
const AlertDialogCancel = React.forwardRef<
    ...
    React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Cancel> & AlertDialogCancelProps
>(({ className, variant, size, ...props }, ref) => (
